...
public class Alat_Musik_Fragment extends Fragment implements MainView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_alat__musik_, container, false);

        rvBudaya = rootView.findViewById(R.id.rv_alat_musik);
